                    ...
                    <ul class="list-inline mb-0 d-flex align-items-center justify-content-end ">
                            ...
                            <li class="list-inline-item dropdown">
                                <?php
                                    $notifications = \App\Models\Notification::latest()
                                        ...
                                        ->take(10)
                                        ->get();
                                    $unseen_notification = \App\Models\Notification::where(
                                        'notifiable_id',
                                        Auth()->user()->id,
                                    )
                                        ->where('read_at', null)
                                ...
                                <a href="javascript:void(0)" class="dropdown-toggle text-reset no-arrow p-5px"
                                    ...
                                    <?php if($unseen_notification > 0): ?>
                                        <span
                                            class="badge badge-dot badge-sm badge-status no-border badge-primary"></span>
                                    <?php endif; ?>
                                </a>
                                                    ...
                                                    <div class="media">
                                                        <span class="avatar avatar-sm mr-3 flex-shrink-0">
                                                            ...
                                                            <?php if($chat->chatThread->$user_to_show->photo != null): ?>
                                                                <img
                                                                    src="<?php echo e(uploaded_asset($chat->chatThread->$user_to_show->photo)); ?>">
                                                            <?php else: ?>
                                                                <img
                                                        ...
                                                        <div class="media-body minw-0">
                                                            ...
                                                            <?php if($chat->message != null): ?>
                                                                <div class="fs-12 text-truncate opacity-60">
                                                                    <?php echo e($chat->message); ?></div>
                                                            <?php else: ?>
                                                                <div class="fs-12 text-truncate opacity-60">
                                                                    <?php echo e(translate('Attachments')); ?>
                                                        ...
                                                        <div class="ml-2 text-right">
                                                            <div class="opacity-60 fs-10 mb-1">
                                                                <?php echo e(Carbon\Carbon::parse($chat->created_at)->diffForHumans()); ?>
                        ...
                        <?php else: ?>
                            <li class="list-inline-item ml-4">
                                <a class="text-reset opacity-60"
                                    href="<?php echo e(route('login')); ?>"><?php echo e(translate('Log In')); ?></a>
                            </li>
                    ...
                    <div class="logo">
                        <a href="<?php echo e(route('home')); ?>" class="d-inline-block py-15px">
                            <?php if(get_setting('header_logo') != null): ?>
                                <img src="<?php echo e(uploaded_asset(get_setting('header_logo'))); ?>"
                                    alt="<?php echo e(env('APP_NAME')); ?>" class="mw-100 h-30px h-md-40px" height="40">
                            <?php else: ?>
                    ...
                    <ul
                        ...
                        <li
                            ...
                            <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center bg-white py-2"
                                ...
                                <span class="text-primary-grad mb-n1"><?php echo e(translate('Search Match')); ?></span>
                            </a>
                        </li>
                        <li
                            class="d-inline-block d-lg-flex pb-1 <?php echo e(areActiveRoutes(['packages'], 'bg-primary-grad')); ?>">
                            <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center bg-white py-2"
                        ...
                        <li class="d-inline-block d-lg-flex pb-1">
                            <a class="btn btn-sm bg-primary-grad fw-700 fs-15 d-flex align-items-center  fw-600 py-1 border"
                                href="<?php echo e(route('register')); ?>">
                                <span class="mb-n1 text-white">Parent Registration</span>
                            </a>
                        </li>
                        <!-- <li class="d-inline-block d-lg-flex pb-1">-->
                        <!--    <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center bg-white py-2"-->
                        <!--        href="<?php echo e(route('register')); ?>">-->
                        <!--         <span class="text-primary-grad mb-n1"><?php echo e(translate('Registration')); ?></span>-->
                        ...
                        <!--</li>-->
                        <li
                            class="d-inline-block d-lg-flex pb-1 <?php echo e(areActiveRoutes(['contact_us'], 'bg-primary-grad')); ?>">
                            <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center bg-white py-2"
                                href="<?php echo e(route('contact_us')); ?>">
                                <span class="text-primary-grad mb-n1"><?php echo e(translate('Contact Us')); ?></span>
                            </a>
                        </li>
                    </ul>
                </div>
...
<?php /**PATH /Users/jeetpandya/Desktop/workspace/MySmartSolution/nikaah/resources/views/frontend/inc/header.blade.php ENDPATH**/ ?>