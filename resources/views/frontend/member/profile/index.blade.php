            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <select class="form-control aiz-selectpicker marital_status" name="marital_status"
        ...
        <form action="{{ route('member.saveMemberAllInfo', $member->member->id) }}" method="POST" id="saveFamilyInfo">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-md-6">
                            <label for="father">{{ translate('Father’s Name / Guardian Name”') }}</label>
                        ...
                        <div class="col-md-6 mt-2">
                            <label for="father_phone">{{ translate('Father’s Phone Number') }}</label>
                            <input type="text" name="father_phone"
                                value="{{ $member->families->father_phone ?? '' }}"
                                placeholder="{{ translate('Father Phone Number') }}" class="form-control">
                            @error('father_phone')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 mt-2">
                            ...
                            <input type="text" name="mother_phone"
                                ...
                                placeholder="{{ translate('Mother Phone Number') }}" class="form-control">
                            @error('mother_phone')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    @if (
                        ...
                        @foreach ($siblings as $index => $sibling)
                            <div class="sibling-fields form-group row">
                                <div class="col-md-4">
                                    <label for="sibling">{{ translate('Sibling Name') }} </label>
                                ...
                                <div class="col-md-4">
                                    <label for="sibling">{{ translate('Sibling Gender') }} </label>
                                    <select name="relation[]" class="form-control" required>
                                        <option value="male"
                                            {{ isset($relation[$index]) && $relation[$index] == 'male' ? 'selected' : '' }}>
                                            Male</option>
                                        <option value="female"
                                            {{ isset($relation[$index]) && $relation[$index] == 'female' ? 'selected' : '' }}>
                                            Female</option>
                                    </select>
                                </div>

                                <div class="col-md-4">
                                    <label for="sibling">{{ translate('Younger or Elder') }} </label>
                                    <select name="Yon_old[]" class="form-control" required>
                                        <option value="younger"
                                            {{ isset($Yon_old[$index]) && $Yon_old[$index] == 'younger' ? 'selected' : '' }}>
                                            Younger</option>
                                        <option value="elder"
                                            {{ isset($Yon_old[$index]) && $Yon_old[$index] == 'elder' ? 'selected' : '' }}>
                                            Elder</option>
                                    </select>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function addSiblingFields() {
                ...
                <div class="sibling-fields form-group row">
                    <div class="col-md-4">
                        <label for="sibling${siblingCount}">Sibling Name</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="sibling_phone[]" class="form-control" placeholder="Sibling Mobile Number" >
                    </div>
