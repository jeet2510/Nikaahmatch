...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'first_name','middle_name', 'last_name', 'user_type','email', 'password', 'code', 'phone','membership','approved', 'verification_code','fcm_token','referred_by','email_verified_at', 'parent_id'
    ];
